...
public class CharacterMovement : MonoBehaviour
{
    ...
    public void showResourceHP(GameObject resource)
    {
        ...
        {
            ResourcesHPDisplay.text = "Target HP: " + resource.GetComponent<ResourcesManager>().health + 
                                                "|" + resource.GetComponent<ResourcesManager>().maxHealth;
    ...
    public void HarvestResourcesWithEachWeapon(GameObject resource, int handDamage, 
                                    int swordDamage, int axeDamage,int pickaxeDamage)
    {
